...
DEFINES += INTERRUPT_TYPE_THREAD_GUARD=2
DEFINES += INTERRUPT_TYPE_SCOPE_GUARD=3
DEFINES += INTERRUPT_TYPE_NON_INTERRUPT=4
DEFINES += INTERRUPT_TYPE_CATCH=5
DEFINES += INTERRUPT_TYPE_MANUAL=6
